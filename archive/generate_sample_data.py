...
def generate_qqq_data():
    """Generate realistic QQQ historical data."""
    ...
    df.to_csv('data/QQQ.csv')
    
    print(f"Generated {len(df)} bars of QQQ data")
    print(f"Saved to data/QQQ.csv")
